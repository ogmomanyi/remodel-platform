...
type SpaceRecord = { id: string; name: string; space_type: string };
type MoodboardRecord = { id: string; name: string; project_space_id: string | null; style_direction: string; palette: unknown; description: string | null; notes: string | null };
type DesignRecord = { id: string; name: string; project_space_id: string | null; elements: unknown };
type SourceAssetRecord = { id: string; space_id: string | null; kind: string; alt_text: string | null; storage_path: string };
type MoodboardItemRecord = { title: string; category: string; notes: string | null };
