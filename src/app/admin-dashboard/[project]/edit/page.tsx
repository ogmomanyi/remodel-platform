...
export default async function DesignStudioPage({ params }: { params: Promise<{ project: string }> }) {
  ...
  let emails = project.allowed_emails; let spaces: Space[] = []; let designs: Array<{ id: string; name: string; elements: DesignElement[]; version: number; updated_at: string; space_id?: string | null }> = [];
  if (dbProject) {
